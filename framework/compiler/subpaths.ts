...
export const SUBPATHS: Record<string, SubpathDecl> = {
  ...
  net: { file: "framework/src/net/index.ts", aliases: TWINS },
  "net/http": { file: "framework/src/net/http.ts", aliases: TWINS },
  "net/websocket": { file: "framework/src/net/websocket.ts", aliases: TWINS },
